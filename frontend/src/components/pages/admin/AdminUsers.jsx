...
function ActionBtn({ onClick, title, children, danger }) {
    return (
        <button
            ...
            onMouseEnter={e => e.currentTarget.style.background = danger ? "rgba(239,68,68,0.12)" : "rgba(124,58,237,0.12)"}
                                    ...
                                    <TableCell>
                                        <span className="text-[10px] rounded-full px-2.5 py-0.5 font-semibold whitespace-nowrap"
                                            style={user.role === "ADMIN"
                                                ? { background: "rgba(124,58,237,0.12)", color: "#a855f7", border: "1px solid rgba(124,58,237,0.25)" }
